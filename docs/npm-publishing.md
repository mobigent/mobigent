...
The publish script is idempotent per version: if `@mobigent/react-native@0.1.8` already exists, it skips that package and continues. This makes reruns safer after a partial publish.

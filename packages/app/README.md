...
The root `@mobigent/app` import is intentionally small: app functions, schema helpers, confirmation/status UI, event helpers, and friendly types such as `AppFunctions`, `AppFunctionMap`, and `MobigentApp`.

...
Usage:
  ...
  npm exec --package https://github.com/mobigent/mobigent/releases/download/v0.1.13/create-mobigent-app-0.1.13.tgz -- create-mobigent-app my-demo --package-source github-release --install

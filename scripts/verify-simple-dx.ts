...
assert.match(backendPackageRoot, /pairing\(\): MobigentBackendClient/, "@mobigent/backend should expose backend.pairing() as the clearest app handoff");
for (const typeName of [
  "Backend",
  "BackendOptions",
  "BackendPairing",
...
assert.match(appBackendTargetType, /pairing\?: MobigentAppPairingSource/, "@mobigent/app should accept backend pairing as the clean app handoff");
